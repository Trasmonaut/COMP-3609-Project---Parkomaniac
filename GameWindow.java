                       ...
                       MouseListener
{
    ...
    public GameWindow() {
        ...
        mainPanel.setLayout(new BorderLayout()); // Use BorderLayout to fill the entire window
    
        // create the gamePanel for game entities
    
        gamePanel = new GamePanel();
        gamePanel.setPreferredSize(new Dimension(Toolkit.getDefaultToolkit().getScreenSize())); // Set to full screen size
